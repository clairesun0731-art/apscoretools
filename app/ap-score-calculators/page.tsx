...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "AP Environmental Science, AP Biology, AP Chemistry, AP Calculus AB, AP Human Geography, AP Macroeconomics, and AP World History score calculators are live now.",
  },
  {
      ...
      <section className="container hero hub-hero">
        <div>
          ...
          <p className="lead">
            ...
            Biology, AP Chemistry, AP Calculus AB, AP Human Geography, AP
            Macroeconomics, and AP World History, with more AP scoring
            calculator tools coming soon.
          </p>
