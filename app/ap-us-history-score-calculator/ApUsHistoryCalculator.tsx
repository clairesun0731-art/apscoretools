...
type InputField = "mcq" | "saq_1" | "saq_2" | "saq_3" | "dbq" | "leq";
...
const calculatorName = "ap_us_history_score_calculator";
const subject = "ap_us_history";
...
export default function ApUsHistoryCalculator() {
  const [mcqRaw, setMcqRaw] = useState(38);
  const [saq1, setSaq1] = useState(2);
  const [saq2, setSaq2] = useState(2);
  const [saq3, setSaq3] = useState(2);
  const [dbqRaw, setDbqRaw] = useState(5);
  const [leqRaw, setLeqRaw] = useState(4);
  ...
  return (
    <section
      aria-label="AP U.S. History score calculator"
    ...
    >
      <div className="chem-calculator-header">
        ...
        <h2>Enter your AP U.S. History section scores</h2>

        <p>
          Use your multiple-choice, short-answer, DBQ, and LEQ raw scores to
          estimate your APUSH composite score and AP score range.
        </p>
      </div>
      ...
      <div className="calculator-body chemistry-calculator-body">
        ...
        >
          <div className="chem-input-section">
            ...
            <ScoreField
              helper="Correct answers out of 55 multiple-choice questions"
              id="apush-mcq"
          ...
          <div className="chem-input-section">
            ...
            <ScoreField
              helper="Raw score out of 3"
              id="apush-saq-3"
              label="SAQ 3 Raw Score"
              max={3}
              min={0}
              onChange={(value) => handleInputChange("saq_3", value, setSaq3)}
              value={saq3}
            />
          </div>
        ...
        <aside aria-live="polite" className="chem-result-card">
          ...
          <div className="chem-breakdown-card">
            ...
            <div className="chem-breakdown-row">
              ...
              <strong>{formatScore(result.mcqWeighted, 40)} / 40</strong>
            </div>
            <div className="chem-breakdown-row">
            ...
            <div className="chem-breakdown-row">
              ...
              <strong>{formatScore(result.saqWeighted, 20)} / 20</strong>
            </div>
            <div className="chem-breakdown-row">
              <span>DBQ Weighted Score</span>
              <strong>{formatScore(result.dbqWeighted, 25)} / 25</strong>
            </div>
            <div className="chem-breakdown-row">
              <span>LEQ Weighted Score</span>
              <strong>{formatScore(result.leqWeighted, 15)} / 15</strong>
            </div>
            <div className="chem-breakdown-row">
